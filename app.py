...
db = pymysql.connect(host= "localhost",user= "root",passwd= "", database= 'waste_segr')
my_cursor = db.cursor()
...
def loginuser():
    print("This is the login user function")
    msg = ''
    if request.method == 'POST': #and 'email' in request.form and 'password' in request.form:
        ...
        if account:
            ...
            session['user_password'] = account[4]
...
model = load_model('waste_segr_10_epochs.h5')
